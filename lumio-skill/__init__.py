...
class lumio-skill(MycroftSkill):
    ...
    def initialize(self):
        ...
        mood_intent = IntentBuilder("moodIntent").\
            require("assistantKeyword").build()
        self.register_intent(mood_intent, self.handle_mood_intent)

        assistant_intent = IntentBuilder("assistantIntent").\
            require("assistantKeyword").build()
        self.register_intent(assistant_intent,
                             self.handle_assistant_intent)
    ...
    def handle_mood_intent(self, message):
        self.speak_dialog("welcome, setting lights to mood")

    def handle_assistant_intent(self, message):
        self.speak_dialog("welcome, setting lights to assistant")
